...
<div class="page-content">
    <div class="row">
        <div class="col-md-9">
            <form class="form-horizontal" role="form" action='produk_act.php?jns=edit' method='post' name='form1'
                id='form1' onsubmit='return validasi();' enctype="multipart/form-data">
                <input type="hidden" name="id" id="id" value="<?php echo $id ?>">
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nome Produto</label>
                    <div class="col-sm-5">
                        <input type="text" name="nama" id="nama" value="<?php echo $nama ?>" maxlength="50"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="kategori" id="kategori" class="form-control chosen-select" style="width:300px" ;
                            data-placeholder="-Escolhe Categoria-" required>
							...
							if (mysqli_num_rows($q) > 0) {
								...
								while ($row = mysqli_fetch_array($q)) {
									...
									?>
                            <option value="<?php echo $row['id'] ?>" <?php if ($kategori == $row['id'])
										   echo "selected" ?>>
                                <?php echo $row['nama'] . ' - ' . $row['nama'] ?>
                            </option>
                            <?php }
							}
							?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="harga" id="harga" value="<?php echo FormatAngka($harga) ?>"
                            maxlength="50" class="form-control" autocomplete="off" required />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="sku" id="sku" value="<?php echo $sku ?>" maxlength="30"
