				...
				<?php
					...
					if (mysqli_num_rows($q)>0) 
					{
						...
						while($row = mysqli_fetch_array($q)) {
							...
							if ($proses_dapur=='Y')  $nproses_didapur="<i class='fa fa-check'></i>"; else $nproses_didapur='';
						?>
							<tr>
								...
								<td class="text-center"><?php echo $nproses_didapur;?></td>
								...
								<td>
									...
									&nbsp;<a class="btn btn-danger btn-xs" href="kategori_act.php?jns=hapus&id=<?php echo $id;?>" onclick="return konfirmasi_hapus();">
